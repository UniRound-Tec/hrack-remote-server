...
export const en = {
  ...
  dashboard: {
    ...
    password: {
      ...
      lead: 'Verify your current password, then set a new sign-in password.',
      close: 'Close change password dialog',
      ...
      revokeOtherHint: 'Keep this device signed in and revoke every other active session.',
      save: 'Save new password',
      saving: 'Saving…',
      cancel: 'Cancel',
      success: 'Your password has been updated.',
      mockUnavailable: 'The Root Mock password is managed by the development sign-in. Use a regular account to test a real password change.',
      errors: {
        currentRequired: 'Enter your current password.',
        newRequired: 'Enter a new password.',
        newShort: 'The new password must be at least 8 characters.',
        newLong: 'The new password cannot exceed 128 characters.',
        newSame: 'The new password must differ from the current password.',
        ...
        noCredential: 'This account has no password credential. Continue using its linked sign-in method.',
