...
export const ko = {
  ...
  dashboard: {
    ...
    password: {
      trigger: '비밀번호 변경',
      title: '비밀번호 변경',
      lead: '현재 비밀번호를 확인한 뒤 새 로그인 비밀번호를 설정합니다.',
      close: '비밀번호 변경 창 닫기',
      current: '현재 비밀번호',
      new: '새 비밀번호',
      confirm: '새 비밀번호 확인',
      ...
      show: '비밀번호 표시',
      hide: '비밀번호 숨기기',
      revokeOther: '다른 기기에서 로그아웃',
      revokeOtherHint: '이 기기는 로그인 상태를 유지하고 다른 모든 세션을 해제합니다.',
      save: '새 비밀번호 저장',
      saving: '저장 중…',
      cancel: '취소',
      success: '비밀번호가 변경되었습니다.',
      mockUnavailable: 'Root Mock 비밀번호는 개발 로그인에서 관리합니다. 실제 변경은 일반 계정으로 테스트하세요.',
      errors: {
        currentRequired: '현재 비밀번호를 입력하세요.',
        newRequired: '새 비밀번호를 입력하세요.',
        newShort: '새 비밀번호는 8자 이상이어야 합니다.',
        newLong: '새 비밀번호는 128자를 초과할 수 없습니다.',
        newSame: '현재 비밀번호와 다른 비밀번호를 입력하세요.',
        confirmRequired: '새 비밀번호를 다시 입력하세요.',
        confirmMismatch: '새 비밀번호가 일치하지 않습니다.',
        currentInvalid: '현재 비밀번호가 올바르지 않습니다.',
        noCredential: '이 계정에는 비밀번호 자격 증명이 없습니다. 연결된 로그인 방법을 사용하세요.',
        rateLimited: '시도 횟수가 너무 많습니다. 잠시 후 다시 시도하세요.',
        unauthorized: '세션이 만료되었습니다. 다시 로그인하세요.',
        failed: '비밀번호를 변경할 수 없습니다. 잠시 후 다시 시도하세요.'
      }
    },
