...
void main() {
    ...
    // Opaque light-on-white, then CSS mix-blend-mode: multiply.
    // Windows treats WebGL alpha as premultiplied; partial alpha washed to white.
    float amt = clamp(luma * 0.35, 0.0, 0.16);
    vec3 paper = vec3(1.0);
    gl_FragColor = vec4(mix(paper, uTint, amt), 1.0);
}
`;
